...
import '../../expert/providers/experts_market_provider.dart';


final WholesalesMarketListProvider = StateNotifierProvider.family<WholesalesMarketStateNotifier,
  ...
  final notifier =
  WholesalesMarketStateNotifier(repository: repository,marketCategory: categoryPair);

  return notifier;
});

class WholesalesMarketStateNotifier extends StateNotifier<PaginationBase> {
  final MarketRepository repository;
  final MarketCategory marketCategory;

  WholesalesMarketStateNotifier({
  ...
  Future<void> paginate({
    ...
    try {
      ...
      final res = await repository.getMarketsWholesalePagenate(id: marketCategory.marketId,paginationParams: paginationParams);
