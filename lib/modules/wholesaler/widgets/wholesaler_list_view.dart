...
class wholesalerItem extends StatelessWidget {
  final wholesalerModel wholesaler;

  const wholesalerItem({required this.wholesaler, Key? key}) : super(key: key);
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: NetworkImage(wholesaler.thumbnail ?? ''),
                              fit: BoxFit.cover)),
                    ),
                    Expanded(
                        flex: 1,
                        child: Container(
                          child: Column(
                            ...
                            children: [
                              ...
                              Wrap(
                                children: wholesaler.middleCategories!
                                    .map((item) =>
