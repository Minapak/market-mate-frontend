...
import '../screens/member_edit_image_screen.dart';
...
// 이미지 업로드 상태 관리자를 정의
final memberEditImageNotifierProvider = StateNotifierProvider<MemberEditImageNotifier, ServerStatusBase>((ref) {
...
class MemberEditImageNotifier extends StateNotifier<ServerStatusBase> {
  ...
  Future<void> onSubmit() async {
    print('memberEditImageNotifier_onSubmit()');
    final Dio dio = Dio();
