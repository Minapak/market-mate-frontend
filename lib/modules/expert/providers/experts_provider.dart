...
final expertListProvider = StateNotifierProvider.family<ExpertsStateNotifier,
  ...
  final notifier =
  ExpertsStateNotifier(repository: repository, categoryPair: categoryPair);

  return notifier;
});

class ExpertsStateNotifier extends StateNotifier<PaginationBase> {
  final ExpertRepository repository;
  final CategoryPair categoryPair;

  ExpertsStateNotifier({
