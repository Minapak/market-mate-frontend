...
class ExpertRegisterProgressbar extends StatefulWidget {
  final int step;

  ExpertRegisterProgressbar({required this.step});

  @override
  ExpertRegisterProgressbarState createState() => ExpertRegisterProgressbarState();
}

class ExpertRegisterProgressbarState extends State<ExpertRegisterProgressbar> with SingleTickerProviderStateMixin {
